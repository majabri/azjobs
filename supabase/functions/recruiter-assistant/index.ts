...
serve(async (req) => {
  ...
  try {
    ...
    const typeInstructions: Record<string, string> = {
      thank_you:
        "Write a warm, professional thank-you reply. Acknowledge the opportunity and express genuine interest.",
      ...
      follow_up:
        "Write a polite follow-up email checking on the application status. Be professional but not pushy. Reference the original conversation.",
      negotiate:
        "Write a professional, confident response to negotiate offer terms. Be respectful but firm. Ask for specifics if the offer details aren't clear.",
      decline:
        "Write a gracious, professional decline. Thank them for the opportunity, express that it wasn't the right fit at this time, and leave the door open for future opportunities.",
    };
