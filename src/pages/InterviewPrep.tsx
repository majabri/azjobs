        ...
        {!started ? (
          <div className="max-w-xl mx-auto space-y-6">
            ...
            <Card className="p-6 space-y-4">
              ...
              <Button className="gradient-brand text-white shadow-brand hover:opacity-90 w-full" onClick={startInterview}>
          ...
          <div className="flex flex-col h-[calc(100vh-10rem)]">
            ...
            <div className="flex gap-3 pt-4 border-t border-border">
              ...
              <Button className="gradient-brand text-white" onClick={sendMessage} disabled={streaming || !input.trim()}>
