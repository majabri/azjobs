      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <select
            ...
            className="px-4 py-2 bg-gray-800 border border-gray-700 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-teal-500"
          >
        ...
        {services.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map(service => (
              <Card
                key={service.id}
                className="bg-gray-800 border-gray-700 overflow-hidden hover:border-teal-500/50 transition-all"
              >
                {/* Service Image */}
                <div className="relative h-48 bg-gray-700 overflow-hidden">
                  ...
                  <button
                    ...
                    className="absolute top-2 right-2 p-2 bg-gray-900/75 rounded-full hover:bg-gray-900 transition-colors"
                  >
                    <Heart
                      className={`w-5 h-5 ${
                ...
                <div className="p-4">
                  ...
                  {/* Tiers */}
                  <div className="mb-4">
                    <p className="text-xs text-gray-400 mb-2">STARTING FROM</p>
                    {service.tiers && service.tiers.length > 0 ? (
                      <div className="space-y-2">
                        {service.tiers.map(tier => (
                          <div
                            key={tier.id}
                            className="p-3 bg-gray-700/50 rounded border border-gray-600 hover:border-teal-500/50 cursor-pointer transition-colors"
                          >
