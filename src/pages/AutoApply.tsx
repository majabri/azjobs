      ...
      <div className="max-w-5xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="grid grid-cols-3 gap-3">
          {([
            ...
            <Card
              key={m.mode}
              className={`p-4 cursor-pointer transition-all ${prefs.applyMode === m.mode ? "border-accent bg-accent/5 shadow-brand" : "hover:border-accent/30"}`}
        ...
        <Card className="p-6">
          ...
          <div className="mt-6 flex items-center gap-3">
            <Button className="gradient-brand text-white shadow-brand hover:opacity-90" disabled={isSearching} onClick={runAutoSearch}>
                  ...
                  <Card key={item.id} className={`overflow-hidden transition-all ${
                    ...
                    <div className="p-4 flex items-center gap-4">
                      ...
                      <div className="flex items-center gap-1 flex-wrap">
                        {item.status === "review" && (
                          <>
                            <Button size="sm" className="text-xs gradient-brand text-white" onClick={() => { analyzeItem(item); setExpandedId(item.id); }} disabled={isAnalyzing}>
                        ...
                        {item.status === "analyzed" && (
                          <>
                            ...
                            <Button size="sm" className="text-xs gradient-brand text-white" onClick={() => generatePackage(item)} disabled={isGenerating}>
