...
} from "@/hooks/queries/useJobApplications";
          ...
          <div className="bg-success/10 border border-success/30 rounded-2xl p-4 animate-fade-up flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Save your offer details and launch the negotiation engine to
          ...
          <div className="bg-warning/10 border border-warning/30 rounded-2xl p-4 animate-fade-up">
            ...
            <div className="space-y-2">
              {needsFollowUp.map((app) => (
                <div
                  key={app.id}
                  className="flex items-center justify-between bg-background rounded-xl p-3 border border-border"
                >
                  <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
              {COLUMNS.map((col) => {
                ...
                return (
                  <div
                    key={col.id}
                    className={`rounded-2xl border-2 ${col.color} p-3 min-h-[200px]`}
                  >
        ...
        filtered.length === 0 ? (
          <div className="text-center py-16 text-muted-foreground">
            ...
            <p className="text-sm mt-1">
              Run an analysis and track your first application!
            </p>
            <Button
              variant="outline"
              className="mt-4"
