      ...
      <div className="max-w-6xl mx-auto px-6 py-8 space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <Dialog open={showAdd} onOpenChange={setShowAdd}>
            <DialogTrigger asChild>
              <Button size="sm" className="gradient-brand text-white"><Plus className="w-4 h-4 mr-1" /> Add Offer</Button>
            </DialogTrigger>
            <DialogContent>
              ...
              <div className="space-y-3 pt-2">
                ...
                <Button onClick={addOffer} disabled={saving} className="w-full gradient-brand text-white">
        ...
        {loading ? (
          ...
          <div className="text-center py-16 bg-card rounded-2xl border border-border">
            ...
            <Button className="gradient-brand text-white" onClick={() => setShowAdd(true)}>
