          ...
          <div className="animate-fade-up">
            <div className="text-center mb-10">
              <h1 className="font-display text-4xl font-bold text-primary mb-3">
                Find your <span className="text-gradient-indigo">best fit</span> candidates
              </h1>
            ...
            <div className="flex justify-center">
              <Button
                size="lg"
                className="gradient-indigo text-white font-semibold text-lg px-12 py-6 rounded-xl shadow-indigo-500/20 hover:opacity-90 transition-opacity"
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left bg-card rounded-xl border p-4 transition-all hover:shadow-elevated ${
                        isSelected
                          ? "border-accent shadow-indigo-500/20 ring-1 ring-accent/30"
                      ...
                      <div className="flex items-center gap-3">
                        <div
                          className={`w-8 h-8 rounded-full flex items-center justify-center font-display font-bold text-sm flex-shrink-0 ${
                            i === 0 ? "gradient-indigo text-white shadow-indigo-500/20" : "bg-secondary text-secondary-foreground"
                          }`}
                        >
                          #{i + 1}
                        </div>
