...
const BENEFITS_OPTIONS = [
  ...
  "401(k) Match", "Unlimited PTO", "Remote Work",
  "Stock Options", "Flexible Hours", "Professional Development",
  "Gym Membership", "Parental Leave", "Life Insurance",
];
...
const EMPTY_FORM: JobPostingFormData = {
  title: "", company: "", description: "", salaryMin: "", salaryMax: "",
  remoteType: "on-site", skills: [], experienceLevel: "", benefits: [],
  location: "", jobType: "full-time", requirements: "", niceToHaves: "",
};
...
export default function JobPostingForm({ editing, onSaved, onCancel }: Props) {
  ...
  const update = useCallback(<K extends keyof JobPostingFormData>(key: K, val: JobPostingFormData[K]) => {
  ...
  const handleSubmit = async (asDraft = false) => {
    ...
    if (error) {
      ...
      toast.success(form.id ? "Posting updated!" : asDraft ? "Draft saved!" : "Posting published!");
    ...
    <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
      ...
      <div className="lg:col-span-3 space-y-5">
        ...
        {step === 1 && (
          <div className="space-y-4">
            ...
            <div className="p-3 rounded-lg border border-primary/20 bg-primary/5 space-y-2">
              ...
              <p className="text-xs text-muted-foreground">Enter a job title, then click generate to auto-fill the description</p>
              <Button onClick={handleAIGenerate} disabled={generating || !form.title.trim()} size="sm" className="gap-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <Input value={form.title} onChange={(e) => update("title", e.target.value)} placeholder="Senior Software Engineer" />
              </div>
              <div className="space-y-1.5">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <Input type="number" value={form.salaryMax} onChange={(e) => update("salaryMax", e.target.value)} placeholder="120000" />
              </div>
            </div>
        ...
        {step === 2 && (
          <div className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-xs font-medium text-muted-foreground">Remote Type</label>
              <Select value={form.remoteType} onValueChange={(v) => update("remoteType", v)}>
                <SelectTrigger><SelectValue /></SelectTrigger>
                <SelectContent>
