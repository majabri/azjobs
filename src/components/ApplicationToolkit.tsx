      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        {jobLink && (
          <a
            ...
            className="flex items-center gap-2 px-4 py-3 rounded-xl gradient-indigo text-sm font-bold text-white shadow-lg hover:opacity-90 transition-opacity text-center justify-center"
          >
