...
import {
  Loader2, Briefcase, FileText, Copy,
  Target, Package, Mail,
  ChevronDown, ChevronUp, Eye, ExternalLink, CheckCircle2,
} from "lucide-react";
          ...
          {item.status === "review" && (
            <>
              <Button
                ...
                onClick={() => { onAnalyze(); onToggleExpand(); }}
              ...
              <Button size="sm" variant="outline" className="text-xs" onClick={onToggleExpand}>
            ...
            <>
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  window.open(`/job-seeker?prefillJob=${encodeURIComponent(jobDesc)}`, "_blank");
                }}
              >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-3">
                ...
                <div className="text-center p-2 bg-card rounded-lg border border-border">
                  <div className="text-lg font-bold text-success">
                    {item.analysis.matchedSkills.filter(s => s.matched).length}
                  </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Button
                  ...
                  onClick={() => { navigator.clipboard.writeText(item.resume!); toast.success("Copied!"); }}
                >
          ...
          {item.coverLetter && (
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Button
                  variant="ghost" size="sm" className="text-xs"
                  onClick={() => { navigator.clipboard.writeText(item.coverLetter!); toast.success("Copied!"); }}
                >
                  <Copy className="w-3 h-3 mr-1" /> Copy
                </Button>
              </div>
