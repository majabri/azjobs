...
const REPLY_TYPES: { value: ReplyType; label: string; desc: string }[] = [
  {
    value: "thank_you",
    label: "Thank You",
    desc: "Acknowledge receipt of their message",
  },
  {
    value: "schedule_interview",
    label: "Schedule Interview",
    desc: "Propose or confirm interview times",
  },
  {
    value: "follow_up",
    label: "Follow Up",
    desc: "Check in on application status",
  },
  {
    value: "negotiate",
    label: "Negotiate Offer",
    desc: "Counter or discuss offer terms",
  },
  {
    value: "decline",
    label: "Decline Politely",
    desc: "Gracefully decline an opportunity",
  },
];
      ...
      replyType === "schedule_interview"
        ...
        : replyType === "negotiate"
          ...
          : replyType === "follow_up"
            ...
            : "Thank You";
    window.open(
      `mailto:?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(draftReply)}`,
      "_blank",
    );
  };
      ...
      <Card className="p-4 space-y-4">
        ...
        >
          {loading ? (
            ...
            <>
              <Sparkles className="w-4 h-4 mr-2" /> Draft Reply
            </>
          )}
        </Button>
      </Card>
