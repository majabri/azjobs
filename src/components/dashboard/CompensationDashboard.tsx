    ...
    <Card className="p-6">
      ...
      <Tabs defaultValue="benchmark" className="space-y-4">
        ...
        <TabsContent value="benchmark" className="space-y-4">
          <Button onClick={runBenchmark} disabled={loadingBenchmark} className="gradient-brand text-white w-full">
        ...
        <TabsContent value="offer" className="space-y-4">
          <Button onClick={analyzeOffer} disabled={loadingOffer} className="gradient-brand text-white w-full">
        ...
        <TabsContent value="strategy" className="space-y-4">
          <Button onClick={generateStrategy} disabled={loadingStrategy} className="gradient-brand text-white w-full">
        ...
        <TabsContent value="scripts" className="space-y-4">
          <Button onClick={generateScripts} disabled={loadingScripts || !strategy} className="gradient-brand text-white w-full">
