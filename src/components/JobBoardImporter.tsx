      ...
      {importedJobs.length === 0 ? (
        <div className="space-y-4">
          ...
          <div className="flex gap-3">
            <Button className="gradient-brand text-white shadow-brand hover:opacity-90" onClick={handleImport} disabled={!rawInput.trim()}>
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-3">
            {doneJobs.length === 0 && (
              <Button className="gradient-brand text-white shadow-brand hover:opacity-90" onClick={analyzeAll} disabled={analyzing}>
