...
export default function ResumeComparison({
  ...
  const handleSaveAsVersion = async () => {
    ...
    try {
      ...
      setSaved(true);
      toast.success(
        "Resume saved as new version! Future analyses will use this stronger resume.",
      );
    } catch {
  ...
  const estimatedInterviewDelta = Math.min(
    25,
    Math.round(improvementScore * 0.6),
  );
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Badge
            variant="outline"
            className="border-accent/30 text-accent text-sm font-bold px-3 py-1"
          >
        ...
        <Button
          ...
          className={
            saved
              ...
              : "gradient-indigo text-white shadow-indigo-500/20 hover:opacity-90"
          }
